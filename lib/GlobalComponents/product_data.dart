class ProductData {
  String productTitle, productPrice, productDiscount, productRating, productImage, storeType, storeName, productDescription;
...
List<ProductData> productList = [
  ProductData(
    ...
    storeName: 'Maan Store',
  ),
  ProductData(
    productTitle: 'Vintage Dress',
    productPrice: '\$299',
    productDiscount: '40',
    productRating: '(4.7)',
